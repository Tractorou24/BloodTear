...
private:
    ...
    /// \brief The effect to spawn when the enemy dies.
    UPROPERTY(EditAnywhere, Category = "Death", meta = (AllowPrivateAccess = "true"))
    class UNiagaraSystem* DeathEffect = nullptr;

    /// \brief The duration of the death effect.
    UPROPERTY(EditDefaultsOnly, Category = "Death", meta = (AllowPrivateAccess = "true", ClampMin = "0.0", UIMin = "0.0"))
